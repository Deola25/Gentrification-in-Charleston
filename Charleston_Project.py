...
charleston_2000=pd.read_csv(r'G:\pypy\charleston\charleston_2000\DEC_00_SF3_P006_with_ann.csv')
charleston_2010=pd.read_csv(r'G:\pypy\charleston\charleston_2010\DEC_10_SF1_P3_with_ann.csv')
charleston_2016=pd.read_csv(r'G:\pypy\charleston\charleston_2016\ACS_16_5YR_B02001_with_ann.csv')
...
south_carolina=gpd.read_file(r'G:\pypy\charleston\cb_2017_45_tract_500k\cb_2017_45_tract_500k.shp')
...
fig.savefig(r'G:\pypy\charleston\Percent_minority_change_from 2000_to_2010.png')
...
fig.savefig(r'G:\pypy\charleston\Percent_minority_change_from 2010_to_2016.png')
...
fig.savefig(r'G:\pypy\charleston\Percent_minority_change_from 2000_to_2016.png')


'''To save the table that was created from the study'''
charleston_w_pop.to_csv(r'G:\pypy\charleston\Charleston_Temporal_Population_Data.csv', index=False)
...
with open(r'G:\pypy\charleston\charleston_report.txt','w', encoding = 'utf-8') as  d:
